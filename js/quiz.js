(function($) {
    ...
    var myColor;
    var all_questions = [{
        question_string: "ჯავასკრიპტი არის _________ .",
        choices: {
            correct: "სკრიპტი",
            wrong: ["სტილების ცხრილები", "აპლიკაცის", "თამაშების"]
        }
    }, {
        question_string: "რომელი თვისება გამოიყენება ტექსტის ფერის შესაცვლელად?.",
        choices: {
            correct: "color:",
            wrong: ["fontcolor:", "textcolor:", "color:"]
        }
    }, {
        question_string: "რას ნიშნავს CSS",
        choices: {
            correct: "Cascad Style Sheets",
            wrong: ["font", "Custom Style Sheets", "Custom  Sheets"]
        }
    }, {
        question_string: 'როდესაც ცვლადის აღწერის დროს, მას არ მივანიჭებთ მნიშვნელობას, მისი საწყისი მნიშვნელობა იქენბა:?',
        choices: {
            correct: "undefined",
            wrong: ["null", " ' ", "null"]
        }
    }, {
        question_string: 'რომელი მეთოდი ამატებს ახალ ელემენტს ჯავასკრიპტის მასივის ბოლოს?',
        choices: {
            correct: "push()",
            wrong: ["addToEnd()", "add()", "POP()"]
        }
    }];
    ...
    Quiz.prototype.render = function(container) {
        ...
        $('#submitButton').click(function() {
            ...
            var scoremessage = score + " შენი ქულა " + self.questions.length + "მადლობა";
            var icon = '';
            var chartcolor = '';
            ...
            $('.score-label h1').html('<small>გამარჯობა </small>' + username + ', ' + 'შენი ქულა<i class="smiley"></i>');
